function CGame(oData){
    ...
    this._initLevel = function(){
        ...
        document.dispatchEvent(new CustomEvent("start_level",{detail: { level: s_iCurLevel+1 } }));
        _aCar = new Array();
        var iRandPosX;
        var iRandType;
    ...
    this._checkNewLevel = function(){
        _iFrogInNest++;
        if(_iFrogInNest === 5){
            document.dispatchEvent(new CustomEvent("end_level",{detail: { level: s_iCurLevel+1 } }));
            document.dispatchEvent(new CustomEvent("save_score",{detail: { score: s_iScore } }));
