! function(e, t) {
    "object" == typeof exports && "undefined" != typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define(t) : e.AlertaAdblock = t()
}(this, function() {
    "use strict";

    function e() {
        if (void 0 === arguments[0]) return console.error("APPSWISE Adblock expects at least 1 attribute!"), !1;
        var e = c({}, j);
        switch (typeof arguments[0]) {
            ...
            case "object":
                ...
                break;
            default:
                return console.error('APPSWISE Adblock: Unexpected type of argument! Expected "string" or "object", got ' + typeof arguments[0]), !1
        }
        K(e);
        var n = f();
        return new Promise(function(o, r) {
            ...
            switch (e.input) {
                ...
                case null:
                    break;
                default:
                    console.error('Adblock: Unexpected type of input! Expected "text" or "email" or "password", "select", "checkbox", "textarea" or "file", got "' + e.input + '"')
            }
            "select" !== e.input && "radio" !== e.input || (e.inputOptions instanceof Promise ? (t.showLoading(), e.inputOptions.then(function(e) {
                t.hideLoading(), I(e)
            })) : "object" == typeof e.inputOptions ? I(e.inputOptions) : console.error("APPSWISE Adblock: Unexpected type of inputOptions! Expected object or Promise, got " + typeof e.inputOptions)), W(), U(e.animation, e.onOpen), a(-1, 1)
        })
    }
    ...
    var n = "AlertaAdblockPlus-",
        ...
        l = '<div class="' + i.overlay + '" tabIndex="-1"></div><div class="' + i.modal + '" style="display: none" tabIndex="-1"><div class="' + i.icon + " " + r.error + '"><span class="x-mark"><span class="line left"></span><span class="line right"></span></span></div><div class="' + i.icon + " " + r.question + '">?</div><div class="' + i.icon + " " + r.warning + '">!</div><div class="' + i.icon + " " + r.info + '">i</div><div class="' + i.icon + " " + r.success + '"><span class="line tip"></span> <span class="line long"></span><div class="placeholder"></div> <div class="fix"></div></div><img class="' + i.image + '"><h2></h2><div class="' + i.content + '"></div><input class="' + i.input + '"><select class="' + i.select + '"></select><div class="' + i.radio + '"></div><label for="' + i.checkbox + '" class="' + i.checkbox + '"><input type="checkbox" id="' + i.checkbox + '"></label><textarea class="' + i.textarea + '"></textarea><div class="' + i.validationerror + '"></div><hr class="' + i.spacer + '"><br/><br/><button class="' + i.confirm + '">OK</button><button class="' + i.cancel + '">Cancel</button><span class="' + i.close + '">&times;</span><br/><br/><span style="font-family:Verdana,Geneva,sans-serif;text-decoration:none;font-size:10px;color:#666;text-shadow: 0.1px 0.1px 1px #999;" align="center">Feeded by: <a href="https://store.appswisegames.com/" target="_blank">APPS WISE™ - Inc.</a></span></div>',
        c = function(e, t) {
        ...
        K = function(e) {
            var t = f();
            for (var n in e) a.hasOwnProperty(n) || "extraParams" === n || console.warn('APPSWISE Adblock: Unknown parameter "' + n + '"');
            e.width = e.width.toString();
            var o, l = e.width.match(/^(\d+)(px|%)?$/);
            if (l ? (o = "px", l[2] && (o = l[2]), l = parseInt(l[1], 10), t.style.width = l + o, t.style.marginLeft = -l / 2 + o) : console.warn('Adblock: Invalid width parameter, usage examples: "400px", "50%", or just 500 which equals to "500px"'), t.style.padding = e.padding + "px", t.style.background = e.background, "px" === o) {
                var c = 5,
                    s = l + l * (c / 100) * 2,
            ...
            if (e.showCloseButton ? S(g) : B(g), t.className = i.modal, e.customClass && C(t, e.customClass), B(t.querySelectorAll("." + i.icon)), e.type) {
                ...
                for (var E in r)
                    if (e.type === E) {
                        x = !0;
                        break
                    } if (!x) return console.error("APPSWISE Adblock: Unknown alert type: " + e.type), !1;
        ...
        U = function(e, t) {
            var n = f();
            e ? (P(m(), 10), C(n, "show-AlertaAdblockPlus"), k(n, "hide-AlertaAdblockPlus")) : S(m()), S(n), d.previousActiveElement = document.activeElement, null !== t && "function" == typeof t && t.call(this, n)
        },
        W = function() {
            var e = f();
    ...
    return t.isVisible = function() {
            ...
            var t = f();
            k(t, "show-AlertaAdblockPlus"), C(t, "hide-AlertaAdblockPlus");
            ...
            N && !g(t, "no-animation") ? t.addEventListener(N, function c() {
                t.removeEventListener(N, c), g(t, "hide-AlertaAdblockPlus") && (A(t), T(m(), 0)), I(l)
            }) : (A(t), A(m()), I(l)), null !== e && "function" == typeof e && e.call(this, t)
        }, t.init = function() {
            if ("undefined" == typeof document) return void console.log("APPSWISE Adblock requires document to initialize");
            ...
            j = c({}, a)
        }, t.version = "5.0.0", window.AlertaAdblock = window.swal = t,
        function() {
        ...
        } : console.warn("APPSWISE Adblock: Please inlude Promise polyfill BEFORE including Adblock.js if IE10+ support needed."), t
});
//
